function position=check_longShort_limit(symbols,lastPrice, midPrice,time, x,y)
    ...
    ynew=ynew{:,:}; limits=[0,0;0,0;0,0;0,0;x,y];
    logMktVal=smartsum(log(ynew+limits).*hedge_ratio,2);
